...
const Info = () => {
  ...
  return (
    ...
    >
      <Button
        variant="contained"
        className="bg-success text-white float-end ms-2"
        data-bs-toggle="modal"
        data-bs-target="#exampleModal"
      >
        Đổi mật khẩu
      </Button>
      <h3 className="col-lg-6 col-md-6 col-sm-6 mx-4 text-center p-2 text-danger">
        Hồ sơ của tôi
      </h3>
      <hr />
              ...
              <Box sx={{ display: "flex", alignItems: "flex-end" }}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    ...
                    onChange={handleChange}
                    color="primary"
                    // Thêm các thuộc tính cho DatePicker
                    sx={{
